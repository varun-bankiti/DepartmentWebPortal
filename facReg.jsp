...
String qry;
qry="select * from temp_pwd where id=?";
ps=con.prepareStatement(qry);
ps.setString(1,id);
ResultSet result=ps.executeQuery();
if(result.next()){
	if(result.getInt(3)==3){
%>
...
<script type="text/javascript">
	window.onload = function(){
		...
		<center><font size=6 >Faculty Registration</font><br />
		<span id="p"></span>
		<br /></center>
		<table style="margin-left:300px;">
		<tbody><tr><td width=150>ID </td><td width=100><input required name="idn" id="stu_id"  type="text" onblur=validate_name(this.id,"id_error")  value=<%=id%>></td><td width=150 id="id_error"></td></tr>
		<tr><td>Name : </td><td><input required name="user" id="stu_name" type="text" onblur=validate_name(this.id,"user_error") onKeyPress="return validateKeyName(event)"></td><td id="user_error"></td></tr>
...
<input type="text" size="12" id="dob" onblur="validateDob()"/>
</td><td id="dob_error"></td></tr>
<tr><td>Address :</td><td><textarea required style='resize:none;' name="add" id="stu_add"></textarea></td></tr>
...
<tr><td>Phone No :</td><td><input required name="phone" type="text" id="stu_phn" onblur=validate_phnum(this.id,"phnum_error") onKeyPress="return validateKeyPhn(event)"> </td><td id="phnum_error"></td></tr>
<tr><form id="photo_form" method="POST" enctype="multipart/form-data" action="savePhotoFac.jsp"><td>Upload Photo</td><td><input type="file" id="file0" name="file0"></td><td><div id="photo_error"></div></td></form></tr>
<tr><td></td><td><input type="button" value="Submit" onclick=facRegis(3)></td></tr>
</tbody></table></center>
		</div>
