...
<div class="body">
			...
			<div id="notices">
			<form id="classDate">
					<table width="700px" cellpadding="0px" align="center">	<tr height="35px" align="center"><td bgcolor="#DDC5FE">Faculty :<b><%=rs.getString(1)%> </b></td>
		...
		<td bgcolor="#DDC5FE">Date : <input type="text" size="12" id="inputField" onclick="calender(this.id)" readonly="true" value=<%=date%> name="date" /></td></tr></table><br /><center><input type="button" value="Get Report" onclick="return view_attendance()" /></center></form>
		<br /><br /></center>
		<div id="attendReport" width="300" height="400"><center>Attendance report will display here</center>
		</div>
			</div>	 
